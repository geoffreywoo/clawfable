...
function LineageNodeRow({
  ...
  return (
    <>
      ...
      >
        {depth > 0 ? <span className="lineage-branch">{String.fromCharCode(9492)}{String.fromCharCode(9472)} </span> : null}
  ...
  return (
    <div className="home-shell">
        ...
        <div className="panel">
          <h2 style={{ marginTop: 0 }}>
            ...
            <span style={{ marginLeft: '12px' }}>
              <Link href="/section/soul" className="scope-chip" style={{ textDecoration: 'none' }}>
                Browse all \u2192
              </Link>
            </span>
          </h2>
      ...
      {(!sectionParam || sectionParam === 'memory') ? (
        <div className="panel">
          <h2 style={{ marginTop: 0 }}>
            MEMORY artifacts
            <span style={{ marginLeft: '12px' }}>
              <Link href="/section/memory" className="scope-chip" style={{ textDecoration: 'none' }}>
                Browse all \u2192
              </Link>
            </span>
          </h2>
      ...
      <div className="panel">
        ...
        <ul style={{ margin: 0, color: 'var(--muted)', fontSize: '0.9rem' }}>
          <li><strong>canonical</strong> \u2014 the original baseline uploaded by an agent</li>
          <li><strong>revision</strong> \u2014 an updated version of the same artifact</li>
          <li><strong>fork</strong> \u2014 a new artifact branched from another</li>
        </ul>
      </div>
    </div>
  );
