...
const ROWS: PortfolioRow[] = [
  ...
  ['Saronic', 'https://www.saronic.com/', 'Autonomous surface vessels for maritime defense.', 'ai_infrastructure_national_resilience'],
  ['General Matter', 'https://generalmatter.com/', 'Nuclear fuel infrastructure.', 'ai_infrastructure_national_resilience'],
  ...
  ['Modal', 'https://modal.com/', 'Cloud infrastructure for AI and data workloads.', 'ai_infrastructure_national_resilience', ['Modal Labs'], ['modal_labs']],
  ...
  ['ElevenLabs', 'https://elevenlabs.io/', 'AI voice research and products.', 'software_finance_applied_ai', ['Eleven Labs'], ['elevenlabsio']],
  ...
  ['Kings League', 'https://kingsleague.pro/', 'Global, creator-led 7 vs 7 soccer league.', 'consumer_platforms_brands'],
  ...
  ['Ketone-IQ', 'https://ketone.com/', 'Ketone-based energy and performance products.', 'consumer_platforms_brands', ['Ketone IQ']],
  ...
  ['Betr', 'https://betr.app/', 'Sports betting, fantasy, and media.', 'consumer_platforms_brands'],
  ['W', 'https://getw.com/', "Men's personal care.", 'consumer_platforms_brands', ['Get W']],
  ['Chronosphere', 'https://chronosphere.io/', 'Cloud observability platform; acquired by Palo Alto Networks for $3.35B.', 'realized_public_outcomes'],
...
const CONSTRUCTIVE_CONVICTION_PATTERN = /\b(?:i\s+(?:think|believe|want|love)|i(?:'d|\s+would)\s+(?:back|bet|buy|choose|expect|make|pick|prefer|take|use)|deserves?|worth|winner|special|underestimated|undervalued|impressive|insane|huge|great|best|ahead|faster|early|cheap|dominant|breakout|real|congrats|congratulations|gets?\s+(?:there|to|it|this|that|better|faster|cheaper|stronger|bigger|interesting)|(?:can|could|will|should)\s+(?:build|become|compound|create|capture|expand|grow|improve|lead|lower|own|prove|reduce|scale|ship|unlock|win))\b/i;
