...
const GEOFFREY_BROAD_SEEDS: FrontierIdeaSeed[] = [
  ...
  },
  {
    ...
    kind: 'ai_product',
    reactionPrompt: 'Use the exact subject for one native move: a blunt valuation, timing, company-status, or competition bet; a real first-person question or desire; or a weird coherent prediction about what ambitious people do next. Do not design a feature or implementation. Avoid permission, authority, workflow, release-gate, task-continuity, and benchmark-comparison takes.',
    ...
    hiddenConstraint: 'the sharp thought is usually about value, status, ambition, timing, competition, or changed human behavior, not an invented product-management requirement',
  ...
  },
  {
    ...
    kind: 'ai_product',
    reactionPrompt: 'Keep the exact named company, person, or product. Make one audacious valuation, timing, status, competition, ambition, or company-quality call, or ask one weird real question. Do not design permissions, workflows, governance, release gates, or benchmark tests. Do not default to an acquisition or CEO-installation fantasy and do not invent a launch.',
    ...
    hiddenConstraint: 'distribution matters, but the native reaction should expose the named company\'s value, ambition, status, timing, or competitive position rather than prescribe a generic workflow',
