...
export const PUBLISHING_V2_FINAL_CRITIC_VERSION = 'publishing-v2-copy-judge-10';
export const PUBLISHING_V2_QUALITY_POLICY_VERSION = 'publishing-v2-hard-gates-31';
export const PUBLISHING_V2_MIN_FINAL_QUALITY_MARGIN = 0.81;
export const PUBLISHING_V2_MIN_AUTOPOST_QUALITY_MARGIN = 0.82;
