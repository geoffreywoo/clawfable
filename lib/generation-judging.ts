...
At most one version per input may begin with first-person language. "i think," "i care," "i'd bet," "i would not underwrite," and "i start/stop trusting" cannot be used as personality wrappers around analyst prose. Keep syntax grammatical and mechanisms causally distinct; never coin phrases such as "autonomy-software its way around."
