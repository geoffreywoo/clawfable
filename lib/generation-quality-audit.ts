...
export async function buildGenerationQualityAudit(agent: Agent) {
  ...
  return {
    ...
    models: {
      ...
      generationPolicy: efficientGeneration ? (process.env.AI_MODEL_POLICY === 'astra_all' ? 'geoffrey-autopost-per-dollar-5-astra-judge' : 'geoffrey-autopost-per-dollar-5') : 'legacy-v2',
