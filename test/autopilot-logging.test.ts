...
vi.mock('@/lib/generation-v2', () => ({
  ...
  PUBLISHING_V2_QUALITY_POLICY_VERSION: 'publishing-v2-hard-gates-104',
...
vi.mock('@/lib/ai', () => ({
  ...
  resolvePublishingV2ModelStacks: vi.fn((handle?: string | null) => {
    ...
    return {
      ...
      reason: geoffrey ? 'geoffrey_gpt_independent_native_variants_after_control_audit' : 'default_gpt_primary',
    };
  }),
