...
const policy: BanditPolicy = {
  ...
  successThreshold: 10,
  formatArms: [
    arm({ arm: 'hot_take', meanReward: 0.73, pulls: 8, ucbScore: 1.01 }),
    arm({ arm: 'question', meanReward: 0.58, pulls: 1, ucbScore: 1.22, coldStart: true }),
  ],
  topicArms: [
    arm({ arm: 'AI', meanReward: 0.76, pulls: 7, ucbScore: 1.02 }),
    arm({ arm: 'startups', meanReward: 0.57, pulls: 2, ucbScore: 1.16 }),
  ],
  lengthArms: [
    arm({ arm: 'short', meanReward: 0.62, pulls: 5, ucbScore: 0.97 }),
    arm({ arm: 'medium', meanReward: 0.66, pulls: 6, ucbScore: 0.98 }),
    arm({ arm: 'long', meanReward: 0.49, pulls: 2, failures: 2, ucbScore: 0.81 }),
  ],
